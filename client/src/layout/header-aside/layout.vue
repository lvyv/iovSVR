    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div class="d2-theme-header" flex-box="0">
        <div class="logo-group" :style="{width: asideCollapse ? asideWidthCollapse : asideWidth}">
          <img v-if="asideCollapse" :src="`${$baseUrl}image/theme/${themeActiveSetting.name}/logo/et-icon-only.png`">
          <img v-else :src="`${$baseUrl}image/theme/${themeActiveSetting.name}/logo/et-all.png`">
        </div>
